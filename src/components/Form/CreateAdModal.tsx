...
export function CreateAdModal(){
    ...
    useEffect(()=>{
      axios('http://18.231.10.201:3333/games').then(response => {
    ...
    async function handleCreateAd(event: FormEvent){
        ...
        try {
        await axios.post(`http://18.231.10.201:3333/games/${data.game}/ads`,{
            name: data.name,
    ...
    return(
        ...
        <Dialog.Content className="bg-[#2a2634] fixed px-8 py-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 overflow-auto rounded-lg h-[650px] w-[480px] shadow-lg shadow-black/25">
          <Dialog.Title className="text-3xl text-white font-black">Publique um anúncio</Dialog.Title>

          <form onSubmit={handleCreateAd} className="mt-3 flex flex-col gap-4 h-[600px]">
